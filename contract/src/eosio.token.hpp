...
namespace eosio
{
   ...
   public:
      ...
      using create_action = eosio::action_wrapper<name("create"), &token::create>;
      using issue_action = eosio::action_wrapper<name("issue"), &token::issue>;
      using retire_action = eosio::action_wrapper<name("retire"), &token::retire>;
      using transfer_action = eosio::action_wrapper<name("transfer"), &token::transfer>;
      using open_action = eosio::action_wrapper<name("open"), &token::open>;
      using close_action = eosio::action_wrapper<name("close"), &token::close>;
